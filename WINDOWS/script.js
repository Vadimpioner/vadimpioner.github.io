...
var timer = function timer(id, deadline) {
  ...
  var setClock = function setClock(selector, endtime) {
    ...
    function updateClock() {
      var y = getTimeRem(endtime);
      days.textContent = addZero(y.days);
      hours.textContent = addZero(y.hours);
      minutes.textContent = addZero(y.minutes);
      seconds.textContent = addZero(y.seconds);
